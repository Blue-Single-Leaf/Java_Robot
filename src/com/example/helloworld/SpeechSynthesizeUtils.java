 ...
 */
public class SpeechSynthesizeUtils
{
    private static SpeechSynthesizeUtils mSpeechSynthesizeUtils = null;
     ...
     * @param context
     */
    private SpeechSynthesizeUtils(Context context, final SynthesizeListener synthesizeListener)
    {
        mContext = context;
     ...
     * @return 当前类唯一实例
     */
    public static SpeechSynthesizeUtils getInstance(Context context, SynthesizeListener recogniseListener)
    {
        if(mSpeechSynthesizeUtils == null)
        {
            synchronized(SpeechSynthesizeUtils.class)
            {
                if(mSpeechSynthesizeUtils == null)
                {
                    mSpeechSynthesizeUtils = new SpeechSynthesizeUtils(context, recogniseListener);
                }
            }
        }
